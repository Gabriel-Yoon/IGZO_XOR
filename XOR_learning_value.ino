...
void loop() {
  ...
  String Input_string; int index[VAR_NUM]= {0,}; // 이는 배열의 모든 요소를 0으로 초기화한다는 의미임
  
  for( int i = 0; i < Bit_length; i++){
    N1_0[i] = 0; N1_1[i] = 0; N1_2[i] = 0; N1_3[i] = 0; N1_4[i] = 0;
    N2_0[i] = 0; N2_1[i] = 0; N2_2[i] = 0; N2_3[i] = 0; N2_4[i] = 0;
    N3_0[i] = 0; N3_1[i] = 0; N3_2[i] = 0; N3_3[i] = 0; N3_4[i] = 0;
    N4_0[i] = 0; N4_1[i] = 0; N4_2[i] = 0; N4_3[i] = 0; N4_4[i] = 0;
  }
...
if (Serial.available() > 0) {
  ...
  int epoch = epoch_string.toInt(); // 여기서부터 epoch 수를 지정해서 for문을 돌려야 할 것으로 보임
   ...
   Serial.print("epoch = "); Serial.print(i+1);
   if(D0 = 10){
    ...
    WL3 = 0;
    WL4 = 0;
    target = X0 ^ X1; // XOR 실험의 target값을 정하기 위하여 C++이나 아두이노에서 XOR을 구현할 때 쓰는 캐럿기호(^)를 통해서 구현하였음
    if(target ==0){
      target_real = 0.25;
    }
    else{
...
int feedforward_operation_2nd(int ds0, int ds1, int ds2, int ds3, int ds4){
  ...
  void Potentiation(int *N1_0, int *N1_1, int *N1_2, int *N1_3, int *N1_4, int *N2_0, int *N2_1, int *N2_2, int *N2_3, int *N2_4, int pulse_width, int pre_enable_time, int post_enable_time, int zero_time){
    ...
    for (int i = 0; i < Bit_length; i++) { 
    if (N1_0[i] == 1) n1_0 = 1 << 12;
    else n1_0 = 0;
    if (N1_1[i] == 1) n1_1 = 1 << 13;
    else n1_1 = 0;
    if (N1_2[i] == 1) n1_2 = 1 << 14;
    else n1_2 = 0;
    if (N1_3[i] == 1) n1_3 = 1 << 15;
    else n1_3 = 0;
    if (N1_4[i] == 1) n1_4 = 1 << 16;
    else n1_4 = 0;
    if (N2_0[i] == 1) n2_0 = 1 << 7;
    else n2_0 = 0;
    if (N2_1[i] == 1) n2_1 = 1 << 6;
    else n2_1 = 0;
    if (N2_2[i] == 1) n2_2 = 1 << 5;
    else n2_2 = 0;
    if (N2_3[i] == 1) n2_3 = 1 << 4;
    else n2_3 = 0;
    if (N2_4[i] == 1) n2_4 = 1 << 3;
    else n2_4 = 0;
...
void Depression(int *N3_0, int *N3_1, int *N3_2, int *N3_3, int *N3_4, int *N4_0, int *N4_1, int *N4_2, int *N4_3, int *N4_4, int pulse_width, int pre_enable_time, int post_enable_time, int zero_time){
  ...
  for (int i = 0; i < Bit_length; i++) {
    if (N3_0[i] == 1) n3_0 = 1 << 17;
    else n3_0 = 0;
    if (N3_1[i] == 1) n3_1 = 1 << 18;
    else n3_1 = 0;
    if (N3_2[i] == 1) n3_2 = 1 << 19;
    else n3_2 = 0;
    if (N3_3[i] == 1) n3_3 = 1 << 9;
    else n3_3 = 0;
    if (N3_4[i] == 1) n3_4 = 1 << 8;
    else n3_4 = 0;
    if (N4_0[i] == 1) n4_0 = 1 << 2;
    else n4_0 = 0;
    if (N4_1[i] == 1) n4_1 = 1 << 1;
    else n4_1 = 0;
    if (N4_2[i] == 1) n4_2 = 1 << 23;
    else n4_2 = 0;
    if (N4_3[i] == 1) n4_3 = 1 << 24;
    else n4_3 = 0;
    if (N4_4[i] == 1) n4_4 = 1 << 25;
    else n4_4 = 0;
